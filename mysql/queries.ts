...
export default function queries(): void {
    ...
    db.query("CREATE TABLE IF NOT EXISTS verification_codes (id INT PRIMARY KEY AUTO_INCREMENT, uid VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, at BIGINT(255) NOT NULL, expires_at BIGINT(255) NOT NULL)");
};