...
const tableDefinitions = [
        ...
        `CREATE TABLE IF NOT EXISTS languages (userid VARCHAR(255) NOT NULL PRIMARY KEY, lang VARCHAR(5) NOT NULL DEFAULT 'en')`,
        `CREATE TABLE IF NOT EXISTS discord_users (id VARCHAR(255) NOT NULL PRIMARY KEY, pfp VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL DEFAULT 'Unknown User', command_executions INT(255) NOT NULL DEFAULT 1, INDEX idx_discord_users_command_executions (command_executions))`,
        `CREATE TABLE IF NOT EXISTS executed_commands (command VARCHAR(255) NOT NULL, uid VARCHAR(255) NOT NULL DEFAULT 0, at BIGINT(255) NOT NULL DEFAULT 0, is_last BOOLEAN NOT NULL DEFAULT TRUE, INDEX idx_executed_commands_at (at), INDEX idx_executed_commands_uid (uid))`,
        `CREATE TABLE IF NOT EXISTS globalchats (guild VARCHAR(255) NOT NULL PRIMARY KEY, channel VARCHAR(255) NOT NULL, enabled BOOLEAN NOT NULL DEFAULT TRUE, banned BOOLEAN NOT NULL DEFAULT FALSE, autotranslate BOOLEAN NOT NULL, language VARCHAR(2) NOT NULL DEFAULT 'es', webhook_token VARCHAR(255) NOT NULL, webhook_id VARCHAR(255) NOT NULL, INDEX idx_globalchats_channel (channel))`,
        `CREATE TABLE IF NOT EXISTS global_messages (id INT(255) NOT NULL PRIMARY KEY AUTO_INCREMENT, uid VARCHAR(255) NOT NULL, content TEXT NOT NULL, language VARCHAR(2) NOT NULL DEFAULT 'es', INDEX idx_global_messages_uid (uid))`,
        `CREATE TABLE IF NOT EXISTS guilds (id VARCHAR(255) NOT NULL PRIMARY KEY, name VARCHAR(255) NOT NULL, member_count INT(255) NOT NULL DEFAULT 2, is_in BOOLEAN NOT NULL DEFAULT TRUE, INDEX idx_guilds_is_in (is_in), INDEX idx_guilds_member_count (member_count))`,
        `CREATE TABLE IF NOT EXISTS global_bans (id VARCHAR(255) NOT NULL PRIMARY KEY, active BOOLEAN NOT NULL DEFAULT TRUE, times INT(255) NOT NULL DEFAULT 1, INDEX idx_global_bans_active (active))`,
        `CREATE TABLE IF NOT EXISTS filter_configs (guild VARCHAR(255) NOT NULL PRIMARY KEY, enabled BOOLEAN NOT NULL DEFAULT TRUE, log_channel VARCHAR(255) NOT NULL DEFAULT '0', enabled_logs BOOLEAN NOT NULL DEFAULT FALSE, lang VARCHAR(2) NOT NULL DEFAULT 'en')`,
        `CREATE TABLE IF NOT EXISTS filter_words (id INT(255) NOT NULL PRIMARY KEY AUTO_INCREMENT, guild VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL DEFAULT '', protected BOOLEAN NOT NULL DEFAULT FALSE, single BOOLEAN NOT NULL DEFAULT TRUE, INDEX idx_filter_words_guild (guild), INDEX idx_filter_words_content (content))`,
        `CREATE TABLE IF NOT EXISTS filter_webhooks (id VARCHAR(255) NOT NULL PRIMARY KEY, token VARCHAR(255) NOT NULL, channel VARCHAR(255) NOT NULL, INDEX idx_filter_webhooks_channel (channel))`,
        `CREATE TABLE IF NOT EXISTS vip_users (id VARCHAR(255) NOT NULL PRIMARY KEY, start_date BIGINT(255) NOT NULL, end_date BIGINT(255) NOT NULL, INDEX idx_vip_users_end_date (end_date))`,
        ...
        `CREATE TABLE IF NOT EXISTS registered_accounts (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, uid VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password TEXT NOT NULL, verified BOOLEAN NOT NULL DEFAULT FALSE, verification_code VARCHAR(255) NOT NULL, verified_at BIGINT(255) NOT NULL DEFAULT 0, created_at BIGINT(255) NOT NULL, last_login BIGINT(255) NOT NULL DEFAULT 0, last_user_logged VARCHAR(255) NOT NULL DEFAULT '0', token VARCHAR(255) NOT NULL DEFAULT '0', password_reset_token VARCHAR(255) DEFAULT NULL, password_reset_expires_at BIGINT(255) NOT NULL DEFAULT 0, INDEX idx_registered_accounts_uid (uid), INDEX idx_registered_accounts_username (username), INDEX idx_registered_accounts_email (email), INDEX idx_registered_accounts_verification_code (verification_code), INDEX idx_registered_accounts_token (token))`,
        ...
        `CREATE TABLE IF NOT EXISTS daily_metrics (metric_date VARCHAR(10) NOT NULL, metric_name VARCHAR(64) NOT NULL, total BIGINT NOT NULL DEFAULT 0, updated_at BIGINT(255) NOT NULL, PRIMARY KEY (metric_date, metric_name), INDEX idx_daily_metrics_name (metric_name), INDEX idx_daily_metrics_updated_at (updated_at))`,
        `CREATE TABLE IF NOT EXISTS daily_distinct_metrics (metric_date VARCHAR(10) NOT NULL, metric_name VARCHAR(64) NOT NULL, entity_id VARCHAR(255) NOT NULL, updated_at BIGINT(255) NOT NULL, PRIMARY KEY (metric_date, metric_name, entity_id), INDEX idx_daily_distinct_metrics_name (metric_name), INDEX idx_daily_distinct_metrics_updated_at (updated_at))`,
