...
export default function queries(): void {
    ...
    db.query("CREATE TABLE IF NOT EXISTS global_messages (id INT(255) NOT NULL PRIMARY KEY AUTO_INCREMENT, uid VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL DEFAULT '[EMPTY MESSAGE]', language VARCHAR(2) NOT NULL DEFAULT 'es')");
