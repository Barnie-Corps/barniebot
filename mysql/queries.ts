...
export default function queries(): void {
    ...
    db.query("CREATE TABLE IF NOT EXISTS ai_monitor_configs (guild_id VARCHAR(255) NOT NULL PRIMARY KEY, enabled BOOLEAN NOT NULL DEFAULT FALSE, logs_channel VARCHAR(255) NOT NULL DEFAULT '0', allow_actions BOOLEAN NOT NULL DEFAULT FALSE, analyze_potentially BOOLEAN NOT NULL DEFAULT FALSE, allow_investigation_tools BOOLEAN NOT NULL DEFAULT FALSE, created_at BIGINT(255) NOT NULL, updated_at BIGINT(255) NOT NULL)");
