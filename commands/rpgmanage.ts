        ...
        switch (sub) {
            ...
            case "edit_item": {
                ...
                if (!validFields.includes(field)) {
                    return utils.safeInteractionRespond(interaction, `❌ Invalid field: ${field}`);
                }
                ...
                if (field === "base_value" || field === "max_stack") {
                    ...
                    if (isNaN(processedValue)) {
                        return utils.safeInteractionRespond(interaction, `❌ ${field} must be a number.`);
                    }
                }
            ...
            case "list_items": {
                ...
                if (!items || items.length === 0) {
                    return utils.safeInteractionRespond(interaction, "No items found matching your filters.");
                }
            ...
            case "list_achievements": {
                ...
                if (!achievements || achievements.length === 0) {
                    return utils.safeInteractionRespond(interaction, "No achievements found.");
                }
            ...
            case "create_material": {
                ...
                if (dropRate < 0 || dropRate > 100) {
                    return utils.safeInteractionRespond(interaction, "❌ Drop rate must be between 0 and 100.");
                }
